(function(){
    ...
    halo.use('loader', function(m){
        m.loader([
            'img3/answer_beibao.png',
            'img3/answer_huochai.png',
            'img3/answer_shamo.png',
            'img3/answer_shiti.png',
            'commonImg/answertoplogo.png',
            'img3/aquestion1.png',
            'img3/kewwordkuang.png',
            'img3/keywordbeibao.png',
            'img3/baidugame.png',
            'commonImg/btn.png',
            'img3/question1.png',
            'img3/question2.png',
